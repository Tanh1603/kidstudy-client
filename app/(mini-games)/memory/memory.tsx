...
function isMemoryGameQuestion(
  ...
  return question && question.gameType === GameTypeEnum.MEMORY && typeof question.memoryType === 'string';
}
...
export const MemoryGameScreen: React.FC = () => {
      ...
      questions.forEach((q) => {
        ...
        switch (selectedMemoryType) {
          case MemoryEnum.WORD_IMAGE:
            ...
            const qWordImage = q as MemoryGameQuestionWithImage;
          ...
          case MemoryEnum.WORD_AUDIO:
            ...
            const qWordAudio = q as MemoryGameQuestionWithAudio;
          ...
          case MemoryEnum.IMAGE_AUDIO:
            ...
            const qImageAudio = q as MemoryGameQuestionWithImageAndAudio;
          ...
          case MemoryEnum.WORD_WORD:
            ...
            const qWordWord = q as MemoryGameQuestionWithWord;
  ...
  // Display message if no questions are available for the selected criteria
  // if (cards.length === 0 && !isLoading) {
  //     return (
  //         <div className="flex flex-col items-center justify-center min-h-screen text-2xl text-white bg-gray-800 p-4 text-center">
  //             <p>Not enough relevant game questions available for this Memory game type and topic.</p>
  //             <p className="mt-2">Please try a different selection or wait for more content.</p>
  //             <motion.button
  //               onClick={() => {
  //                 setCurrentScreen("difficulty"); // Go back to start
  //               }}
  //               whileHover={{ scale: 1.05 }}
  //               whileTap={{ scale: 0.95 }}
  //               className="mt-8 px-6 py-3 bg-blue-600 text-white rounded-xl shadow-md hover:bg-blue-700 transition duration-300"
  //             >
  //               Go Back to Start
  //             </motion.button>
  //         </div>
