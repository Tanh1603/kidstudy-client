...
const MiniGamePage = () => {
  ...
  const { data, isLoading, isError } = useCurrentUserProgress();
  ...
  const checkTicketAndPlay = (gameId: number) => {
    const game = games.find((g) => g.id === gameId);
    if (!game) return;
    if (data.tickets < game?.requiredTickets) {
      toast.error("You don't have enough tickets to play this game!");
      return;
    }
                  ...
                  <div className="relative h-full overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-lg transition-all duration-300 hover:shadow-2xl">
                    ...
                    <div className="relative p-6">
                      ...
                      <div className="text-center">
                        ...
                        {/* Play Button - Smaller */}
                        <Button
                          onClick={() => checkTicketAndPlay(game.id)}
